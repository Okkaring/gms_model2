...
public class SQL {
	public static final String MEMBER_INSERT =  
			String.format("INSERT INTO %s(%s,%s,%s,%s,%s,%s,%s,%s) VALUES(?,?,?,?,?,?,?,SYSDATE)"
			,DB.TABLE_MEMBER, DB.MEMBER_ID,DB.MEMBER_PW,DB.MEMBER_SSN,DB.MEMBER_NAME,DB.MEMBER_PHONE,DB.MEMBER_EMAIL,DB.MEMBER_PRIFILE,DB.MEMBER_REGDATE);
