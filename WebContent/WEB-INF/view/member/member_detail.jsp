            ...
            <div class="row">
                <div class="col-md-3 col-xs-12 col-sm-6 col-lg-3">
                  <div class="thumbnail text-center photo_view_postion_b" >
                    <img src="${img}/defaultimg.jpg" alt="stack photo" class="img">
                  </div>
                </div>
                <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                    <div class="" style="border-bottom:1px solid black">
                      <span style = "font-size: 40px;">${requestScope.student.name}(id: ${requestScope.student.id})</span>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button id = "updateBtn" onclick="moveTo('member','member_update')">정보 수정</button>
                    </div>
                      <hr>
                    <div class="col-md-8">  
                    <ul class=" details">
                      <li><p><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span>num: ${requestScope.student.num}</p></li>
                    ...
                    <div class="col-md-4">  
                      ...
                      <div class="col-sm-5 col-xs-6 tital " >Gender:</div><div class="col-sm-7 col-xs-6 ">${requestScope.student.ssn}</div>
                      <div class="clearfix"></div><div class="bot-border"></div>
                      <div class="col-sm-5 col-xs-6 tital " >Ethnic city:</div><div class="col-sm-7 col-xs-6 ">K-국민</div>
                      <div class="clearfix"></div><div class="bot-border"></div>
                    </div>
                </div>
              </div>
...
function studentInfo(){
	var id = 'id', id_val = '${requestScope.student.id}',
		name ='name', name_val = '${requestScope.student.name}',
		email ='email', email_val = '${requestScope.student.email}',
		phone ='phone', phone_val = '${requestScope.student.phone}';
		
	sessionStorage.setItem(id, id_val);
	sessionStorage.setItem(name, name_val);
	sessionStorage.setItem(email, email_val);
	sessionStorage.setItem(phone, phone_val);
}
</script>
